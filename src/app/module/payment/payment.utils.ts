...
export const generateInvoicePdf = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.moveDown(0.5);
      doc.fontSize(10).font("Helvetica").text("MediNova Healthcare Services", {
        align: "center",
      });
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          "Thank you for choosing MediNova Healthcare. This is an electronically generated invoice.",
          {
            align: "center",
          },
        );
      ...
      doc.text(
        "If you have any questions, please contact us at support@medinova-healthcare.com",
        {
          align: "center",
        },
      );
